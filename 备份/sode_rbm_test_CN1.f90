    ...
    !end module try
      ...
      !do K=6,6
       ...
       do i=1,1
           ...
           epsilon=1.0E-03!1.0E-02-i*1.0E-03
      ...
      write(2019,"(5ES12.2)") epsilon,error2,t2-t1,real(num_M),2.58961660000000
      !call outpdata
...
!    ns=nend
    ...
    error2=abs(apem2-rbmem2)
    write(*,*) 'error0_truth=', abs(u_rbm(0)-apem1),'errror1_truth=',error2
    write(*,*)
    
    write(2018,*) 'error0_truth=', abs(u_rbm(0)-apem1),'errror1_truth=',error2
    write(2018,*)
